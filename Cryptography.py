...
print non_encoder([1, 2], "jongwon")
print xor_encoder([1, 2], [3,4,5,6])
print len(string_to_bits("4h8f.093mJo:*9#$"))
print aes_encoder(string_to_bits("aaaaaa"), string_to_bits("4h8f.093mJo:*9#$"))
print electronic_cookbook(string_to_bits("jongwon"), string_to_bits("4h8f.093mJo:*9#$"), 2, aes_encoder)
# electronic_cookbook(plaintext, key, block_size, block_enc)